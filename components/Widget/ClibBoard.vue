<template>
  ...
  >
    <p
      class="leading-130 absolute md:text-lg sm:text-base text-sm bg-transparent text-[#181919] outline-none overflow-hidden w-[200%] h-4 sm:h-6 left-3 select-none"
    >
      {{ currentRoute }}
    </p>
    <input
