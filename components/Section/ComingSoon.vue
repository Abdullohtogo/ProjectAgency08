<template>
  <div class="relative lg:pt-[248px] md:pt-[122px] sm:py-12 p-6 px-4">
    <div
    ...
    >
      <div class="flex items-start relative z-100">
        <div
          class="flex flex-col max-w-[620px] lg:pb-[222px] md:pb-24 md:pb-15 pb-10"
        >
          <div>
            <h2
    ...
    <div class="yellow-bg bottom-0 right-0"></div>
    <!-- <img
